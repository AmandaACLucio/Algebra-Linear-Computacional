...
from src.utils.matrix_operations import  add_vector_vector, multiply_matrix_scalar, multiply_vector_scalar, multiply_vector_vector, multiply_vector_matrix, multiply_matrix_matrix, sub_vector_vector, norm_vector, multiply_matrix_vector, value_function, inverse_matrix, transpose_vector, add_matrix_matrix, calc_jacobiano
...
def broyden_method(phi_1, phi_2, max_tolerance=0, n_iterations=1000):
    ...
    Bk_previous = calc_jacobiano(vector_x)#[[int(i==j) for i in range(3)] for j in range(3)]
