...
def main(task):
    ...
    if(task==1):
        ...
        task_object= task_2(load_config["OrdemN"], load_config["ICOD"], load_config["IDET"], matrix_a, load_config["TOLm"])
        ...
        task_object= task_4(load_config["ICOD"], load_config["theta1"], load_config["theta2"], load_config["TOLm"])
